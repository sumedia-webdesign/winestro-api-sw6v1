...
use Shopware\Core\Checkout\Cart\Delivery\DeliveryBuilder as DeliveryBuilderAlias;
...
use Sumedia\Wbo\Core\Checkout\Cart\Delivery\Struct\DeliveryPositionCollection;

class DeliveryBuilder extends DeliveryBuilderAlias
{
