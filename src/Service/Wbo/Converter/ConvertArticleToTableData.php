...
class ConvertArticleToTableData
{
    public function convert(Article $article, string $id, string $createdAt): array
    {
        ...
        $data = [
            ...
            'ean' => $article->getEan(),
            'eLabelLink' => $article->getELabelLink(),
            'eLabelExtern' => $article->getELabelExtern(),
            'bestBeforeDate' => $article->getBestBeforeDate(),
            'fat' => $article->getFat(),
            'unsaturatedFats' => $article->getUnsaturatedFats(),
            'carbonhydrates' => $article->getCarbonhydrates(),
            'salt' => $article->getSalt(),
            'fiber' => $article->getFiber(),
            'vitamins' => $article->getVitamins(),
            'freeSulfitAcid' => $article->getFreeSulfitAcid(),
            'sulfitAcid' => $article->getSulfitAcid(),
            'histamines' => $article->getHistamines(),
            'glycerin' => $article->getGlycerin(),
            'labelText' => $article->getLabelText(),
